Download my [Resume](https://github.com/bethelmelesse/bethelmelesse.github.io/blob/main/bethel_resume_2605.pdf)!
...
- Visa: Korea F-2-7 (No Sponsorship Required) | Open to Relocation
...
## Experience 
### AI Engineer, AI Team, 3Billion, Seoul, South Korea (2024 – Present)
- **Forward Synthesis Evaluation Model**: Developed a neural network model to score synthetic feasibility of reaction pathways in an RL-based molecular generation pipeline. Optimized training workflows using PyTorch, RDKit, and DeepChem, achieving 24× speedup (days → 1 hour). Benchmarked performance via AUROC, AUPRC, and Tanimoto similarity in collaboration with experimental chemists.
- **End-to-End Protein-Ligand Interaction Prediction Model**: Developed an E2E model to predict binding pockets, ligand poses, and binding affinities for structure-based drug discovery. Led data preprocessing and graph construction from raw structural formats (PDB, MOL2, SDF) using RDKit, DeepChem, and TorchDrug. Designed and trained multi-task GNN architectures with attention mechanisms. Implemented distributed training across multiple GPUs and established reproducible ML workflows with MLflow for experiment tracking, model versioning, and hyperparameter tuning.

### AI Researcher, DBDC Lab, Ajou University, Suwon, South Korea (2022 – 2024)
...
- Trained a BERT-like transformer language model for information retrieval in African languages.
- Compared traditional methods (TF-IDF, BM25) with state-of-the-art approaches.


## Projects & Open Source Contributions 

### Model Implementation from Scratch
- Implemented foundational deep learning models using PyTorch and NumPy to understand their internal workings across multiple domains: Natural Language Processing, Computer Vision, and Graph Neural Networks.
...
|   |                                                            |
| :----------------------- | :---------------------------------------------------------- |
| **Programming Languages**          | Python, Java, Bash/Shell Script                  |
| **Deep Learning Frameworks**     | PyTorch, TensorFlow, HuggingFace Transformers |
| **DevOps Tools & Version Control**     | Docker, Conda, Venv, Git, GitHub, Linux (Ubuntu) |
| **Machine Learning**     | Deep Neural Networks, Generative Models |
| **Libraries**     | Pandas, NumPy, Scikit-learn, SciPy, RDKit, DeepChem, TorchDrug |
...
| Korean War Scholarship | Embassy of Republic of Korea (2016), Korean War Memorial Foundation (2017-2022), |
|            | Korean War and Military Police Widow's Association (2020), |
...
- Volunteering for NGOs: Korean Saemul Undong Center, The Korea-Africa Foundation Festival, etc.
- Part-time Translator/Interpreter at the Korean War Veterans Revisit Program (2018-2025)
- Barista at Hwacheon Ice Festival
